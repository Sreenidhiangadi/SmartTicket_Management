...
public class DashboardServiceImpl implements DashboardService {
    ...
    public Mono<DashboardSummaryResponse> getSummary() {
        ...
        Mono<Map<TicketStatus, Long>> byStatus =
                Mono.zip(
                        ticketRepository.countByStatus(TicketStatus.CREATED),
        ...
        Mono<Map<TicketPriority, Long>> byPriority =
                Mono.zip(
        ...
        return Mono.zip(total, closed, unassigned, byStatus, byPriority)
                .map(t -> new DashboardSummaryResponse(
                        t.getT1(),
                        t.getT1() - t.getT2(),
                        t.getT2(),
                        t.getT3(),
